\documentclass[moyen, defaultpage]{classeUPD}
...
en colonne \'etroite\marginparnote{pas ici voir
  note~\ref{memoirp}}. Mais j'ai allong\'e la colonne, ce qui interdit
  les notes de bas de page. Notez que c'est le format le plus facile
  pour la lecture, c'est pourquoi les journaux sont dispos\'es sur
  plusieurs colonnes. En revanche j'ai introduit de nouvelles
  ...
  flottantes habituelles, par exemple la
  figure~\ref{figure:fignormal}, ou des
  figures\marginparnote{bigfigure} de taille plus grande mais fix\'ee,
  comme la fig.~\ref{bigfig}, qui utilise en plus la moiti\'e de la
  marge ext\'erieure.
...
Le deuxi\`eme\marginparnote{defaultpage\label{memoirp}} est la mise en page par
